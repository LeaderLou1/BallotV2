    ...
    return(
        ...
        <Flex>
         <div style={{ position: "relative", width: "65%", height: "98vh" }}>
             <img src={Img} alt="sum" style={{ width: "100%", height: "100dvh", objectFit: "cover"}}/>
             <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100dvh", backgroundColor: "rgba(0, 0, 0, 0.3)" }}></div>
             <div style={{ position: "absolute", lineHeight: "-2px", letterSpacing:"-2px", top: "50%", left: "80%", transform: "translate(-70%, -70%)", width:"900px"}}>
                <Text style={{ fontWeight: 'bold', fontSize:"4rem", color: "white", textAlign: "center"}}>Engage in Democracy:</Text>
                <br />
        ...
        <Container>
        <Flex justify="center">
            <Text size="9" style={{margin: "8rem", marginTop:"15rem", fontWeight: 'bold'}}>Who Are You?</Text>
        </Flex>
        <Flex justify="center">
